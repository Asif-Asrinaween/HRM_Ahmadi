 ...
 <div class="container-fluid">
    ...
    <form action="{{ route('Customer.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="tel" name="Phone" class="form-control" placeholder="enter the phone number" pattern="[0-9]{10,12}" required>
            @error('phone')
            <p class="text-danger">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="Add" class="form-control" placeholder="enter the address">
            @error('Add')
            <p class="text-danger">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="date" name="DateOfJoin" class="form-control" value="{{ old('DateOfJoin') }}">
            @error('DateOfJoin')
                <p class="text-danger">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="date" name="DateOfSeparate" class="form-control" value="{{ old('DateOfSeparate') }}">
        ...
        <div class="form-group">
            ...
            <input type="number" name="NID" class="form-control" placeholder="enter the Nation ID">
            @error('NID')
            <p class="text-danger">{{ $message }}</p>
            @enderror
        </div>
    ...
    <select name="Level" class="form-select form-control">
        ...
        <option value="1" {{ old('Level') == '1' ? 'selected' : '' }}>Upper Hand</option>
        <option value="0" {{ old('Level') == '0' ? 'selected' : '' }}>Under Hand</option>
    </select>
    @error('Level')
        <p class="text-danger">{{ $message }}</p>
    @enderror
